...
namespace PavoStudio.MAE
{
    ...
    {
        public static string[] TLabel = { "T.x", "T.y", "T.z" };
        public static string[] QLabel = { "EulerAngle.x", "EulerAngle.y", "EulerAngle.z", "Q.x", "Q.y", "Q.z", "Q.w" };

        public static string[] TProperty = new string[] {
        ...
        public static string[] QProperty = new string[] {
