...
namespace PavoStudio.MAE
{
    ...
    {
        public const string Version = "Muscle Animation Editor 2.4";
        public const string Email = "Email: pavostudio@hotmail.com";
        ...
        void OnEditorUpdate()
        {
            ...
            if (skipCount < tabOption.skippedFrameCount)
            {
                skipCount++;
                return;
            }
        ...
        private void _UpdateTarget()
        {
            ...
            {
                tabMuscle.UpdateAnimationClip();
                tabMuscle.UpdateAnimation();
	 ...
	 ***********************************************/
        ...
        void OnGUI()
        {
            ...
            EditorGUILayout.LabelField(Email, GUILayout.Width(190));
            EditorGUILayout.EndHorizontal();
        }
